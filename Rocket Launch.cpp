...
void page()
{
	...
	drawstring(100, 380, const_cast<char*>("NAME : Aman Aayush"));
	drawstring(100, 360, const_cast<char*>("Roll-No : 102283049"));
	...
	drawstring(100, 100, const_cast<char*>("Press Q to quit"));
	glFlush();
}
